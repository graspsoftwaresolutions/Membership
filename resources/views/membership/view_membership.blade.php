                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="text" disabled value="{{$value->member_number}}" tabindex="2" placeholder="Enter Member Number" name="member_number" id="member_number" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="text" disabled value="{{$value->name}}" tabindex="3" placeholder="Enter Member Name" name="name" id="name" class="form-control">
                                    @if($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="text" disabled value="{{$value->phone}}" tabindex="5" placeholder="Enter Mobile Number" name="phone" id="phone" class="form-control">
                                    <span id="errmsg"></span>
                                    @if($errors->has('phone'))  
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="email" disabled value="{{$value->email}}" tabindex="6" name="email" id="email" placeholder="Enter email" id="exampleInputEmail1" class="form-control">
                                    @if($errors->has('email'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <select tabindex="7" disabled name="designation" id="designation" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <select tabindex="8" disabled name="race" id="race" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                 <select tabindex="9" disabled class="form-control" name="country_id" id="country">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                 <select tabindex="10" disabled name="state_id" id="state" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                 <select tabindex="11" disabled class="form-control" name="city_id" id="city">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <textarea tabindex="12" disabled class="form-control" name="address_one" id="address_one" placeholder="Enter Address">{{$value->address_one}}</textarea>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                 <textarea tabindex="13" disabled name="address_two" id="address_two"  class="form-control" placeholder="Enter Address">{{$value->address_two}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                 <textarea tabindex="14" disabled name="address_three" id="address_three"  class="form-control" placeholder="Enter Address">{{$value->address_three}}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input tabindex="15" disabled type="date" placeholder="Enter Old IC Number" value="{{$value->dob}}" name="dob" id="dob" class="form-control">
                                    @if($errors->has('dob'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="date" disabled tabindex="16" name="doj" id="doj" value="{{$value->doj}}" placeholder="DOJ" id="doj" class="form-control">
                                    @if($errors->has('doj'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="text" disabled tabindex="17" value="{{$value->old_ic}}" placeholder="Enter Old IC Number" name="old_ic" id="phonold_ic" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="col-md-7"> 
                                    <input type="text" disabled tabindex="18" name="new_ic" value="{{$value->new_ic}}" id="new_ic" placeholder="Enter New IC number" id="exampleInputEmail1" class="form-control">
